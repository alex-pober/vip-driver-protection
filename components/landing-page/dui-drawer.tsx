      ...
      <DrawerContent>
        <DrawerHeader className="text-left">
          ...
          <DrawerDescription className="mt-8 overflow-scroll flex flex-col gap-3">
            ...
            <div>
              <h2 className="text-black scroll-m-20 text-xl font-semibold tracking-tight">- Stay Calm and Polite</h2>
              <p className="ml-4 text-sm text-muted-foreground">Being respectful goes a long way.</p>
            </div>

            <div>
              <h2 className="text-black scroll-m-20 text-xl font-semibold tracking-tight">- Exercise Your Right to Remain Silent</h2>
              <p className="ml-4 text-sm text-muted-foreground">Politely decline to answer questions without your attorney present.</p>
            </div>
            ...
            <div>
              ...
              <p className="ml-4 text-sm text-muted-foreground">Call us ASAP!!</p>
            </div>
